...
//         $("#main_content").load("student_stuinfo.html");  //在主体页面  加载页面
//         // $.cookie("stuName", data.data.stuName);
//         // $.cookie("stuNum", data.data.stuNum);
//         window.location.hash='/#/student_stuinfo.html'; //改变地址 index.html#book-manage
//     });
//
//     //页面跳转操作
//     $("#medical_manage").click(function() {
//         $("#main_content").load("medical_manage.html");  //在主体页面  加载页面
//         window.location.hash='/#/medical_manage.html'; //改变地址 index.html#book-manage
//     });
//     //页面跳转操作
//     $("#infoD").click(function() {
//         $("#main_content").load("Ztest.html");  //在主体页面  加载页面
